...
#### 结果
在学习率0.001时，验证准确度为48.53%，最大迭代次数为48，训练时间为22分20秒

在学习率0.003时，验证准确度为53.68%，最大迭代次数为48，训练时间为13分18秒

在学习率0.005时，验证准确度为70.59%，最大迭代次数为48，训练时间为20分28秒

我们可以通过上述数据得出，在学习率0.001时，验证准确度最小，但时间最短，而在学习率0.005时，验证准确度最大，说明选取0.005为学习率最好

### 情况2：128x128

通过改变学习率和最大迭代次数来观察在此维度下哪个学习率能达到最好的效果

学习率：0.005，最大迭代次数：12
#### ![Image text](results/128-128-3/data2.png)
学习率：0.001，最大迭代次数：12
#### ![Image text](results/128-128-3/data3.png)
学习率：0.005，最大迭代次数：24
#### ![Image text](results/128-128-3/data4.png)
学习率：0.003，最大迭代次数：48
...
#### 结果
在学习率0.005时，验证准确度为86.93%，最大迭代次数为12，训练时间为6分52秒

在学习率0.001时，验证准确度为64.71%，最大迭代次数为12，训练时间为9分34秒

在学习率0.005时，验证准确度为85.95%，最大迭代次数为24，训练时间为12分35秒

在学习率0.003时，验证准确度为94.85%，最大迭代次数为48，训练时间为21分46秒

在学习率0.005时，验证准确度为98.87%，最大迭代次数为24，训练时间为15分23秒

在学习率0.001时，验证准确度为81.77%，最大迭代次数为16，训练时间为7分37秒

我们可以通过上述数据得出，在学习率0.001时且最大迭代次数为12次，验证准确度最小，但时间最短，而在学习率0.005时且最大迭代次数为98.87次，验证准确度最大，说明选取0.005为学习率最好
...
#### 结果
在学习率0.001时，验证准确度为94.85%，最大迭代次数为48，训练时间为15分51秒

在学习率0.003时，验证准确度为97.79%，最大迭代次数为32，训练时间为15分21秒

在学习率0.005时，验证准确度为96.32%，最大迭代次数为32，训练时间为10分31秒

我们可以通过上述数据得出，在学习率0.001时，验证准确度最小，时间也是最长的，而在学习率0.003时，验证准确度最大，说明选取0.003为学习率最好
...
正则化参数L2Regularization为1e-5测试集训练效果最好，将维度升高时反而测试集准确度下降
...
对于数据维度的选取，维度提高可以增加拟合程度，如果欠拟合可以尝试提高维度，但有时提高维度带来的噪声影响过大时也会减少拟合程度。
